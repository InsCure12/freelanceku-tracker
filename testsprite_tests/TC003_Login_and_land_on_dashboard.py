...
async def run_test():
    ...
    try:
        ...
        # -> Open the login page by clicking the 'Log In' link in the navbar.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/header/nav/div[3]/a').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Fill the email field with the test email, fill the password, then submit the form by clicking Sign In.
        frame = context.pages[-1]
        # Input text

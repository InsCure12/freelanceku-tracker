...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Filter Project')]").nth(0).is_visible(), "The work log should show the created job with project name Filter Project after applying the filters"

...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        body_text = await frame.locator("xpath=/html/body").nth(0).text_content()
        assert 'Throwaway Client' not in body_text, "The work log should not include a job for Throwaway Client after discarding the draft."

...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Client name is required')]").nth(0).is_visible(), "The new job form should show a validation error 'Client name is required' when attempting to save without a client name"

...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields and click 'Sign In' to log in as the freelancer.
        frame = context.pages[-1]
        # Input text
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Page 2')]").nth(0).is_visible(), "The work log should show Page 2 after navigating to the next page of results"

...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field with example@gmail.com, then fill the password and submit the form.
        frame = context.pages[-1]
        # Input text
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'IDR')]").nth(0).is_visible(), "The default currency should remain set to IDR after saving and revisiting settings within the same session."

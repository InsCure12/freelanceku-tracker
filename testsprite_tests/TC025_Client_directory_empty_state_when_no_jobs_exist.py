...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields on the login form and submit to sign in.
        frame = context.pages[-1]
        # Input text
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'No clients found')]").nth(0).is_visible(), "The client directory should display 'No clients found' indicating there are no clients after deleting all jobs."
